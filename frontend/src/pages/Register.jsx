      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-12 pt-8">
        <div className="mx-auto max-w-md">
          {checkingRegistration ? (
            <p className="text-center text-ink-muted animate-fade-in">
              Loading…
            </p>
          ) : !registrationOpen ? (
            <div className="text-center animate-fade-in rounded-3xl border border-border bg-surface-elevated p-8 shadow-card">
              <p className="text-lg font-medium text-ink">Signups are closed</p>
