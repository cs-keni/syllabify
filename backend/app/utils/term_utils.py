...
def get_or_create_term(user_id: int, term_name: str, start_date=None, end_date=None) -> int:
    """
    ...
    Args:
        ...
        end_date: Optional end date (defaults to 3 months from today if creating)
...
def map_syllabus_json_to_db(user_id: int, syllabus_json: dict) -> dict:
    """
    Transform Kenni's syllabus JSON to include term_id for database insertion.
